...
load('QA_T1_ge.mat') ;
totalData = d;%reshape(d,[512, 32, 256, 11, 2]) ;
Nsample = size(totalData, 1) ; % number of ADC
Ncoil = size(totalData, 2) ; % number of coils
...
SLClbl = repmat(sliceOrder', [1, Nscan/(SLClbl_max+1)]) ;
